...
export default function AssetsList() {
  ...
  const handleSpecificEntry = (asset: any) => {
    Alert.alert(
      "Asset Details",
      `Category: ${asset.main_category}\nItem: ${asset.sub_item}\nPurchase Date: ${asset.purchase_date}\nCost: Rs ${asset.cost}\nPayment Status: ${asset.payment_status}`,
  ...
  return (
    ...
    >
      ...
      {assets.map((asset, index) => (
        <TouchableOpacity
          key={asset.id || index}
          onPress={() => handleSpecificEntry(asset)}
        ...
        >
          ...
          <StatusToggle asset={asset} onToggle={handleToggleStatus} />
